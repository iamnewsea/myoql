 ...
 */
private fun <M : MongoBaseMetaCollection<E>, E : java.io.Serializable> M.remove(fieldName: String, id: String, imageId: String): Int {
 ...
 * @param image 添加的图片
 */
private fun <M : MongoBaseMetaCollection<E>, E : java.io.Serializable> M.add(fieldName: String, id: String, image: IdUrl): Int {
    return this.updateById(id)
            .push { MongoColumnName(fieldName) to image }
            .exec()
}

fun <M : MongoBaseMetaCollection<E>, E : java.io.Serializable> M.swap(fieldName: (M) -> MongoColumnName, id: String, index1: Int, index2: Int): JsonResult {
 ...
 * @param index2 交换项索引
 */
fun <M : MongoBaseMetaCollection<E>, E : java.io.Serializable> M.swap(fieldName: String, id: String, index1: Int, index2: Int): JsonResult {
    if (index1 == index2) {
 ...
 * 图片操作，添加，删除，交换
 */
fun <M : MongoBaseMetaCollection<E>, E : java.io.Serializable> M.imageChange(
...
fun <M : MongoBaseMetaCollection<E>, E : java.io.Serializable> M.imageSet(
