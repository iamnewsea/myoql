...
class SqlBaseGroup : IDataGroup {
    ...
    class s_annex_table(datasource: String = "") :
        ...
        override fun getSpreadColumns(): Array<String> {
            return arrayOf<String>("creator")
        }

        override fun getConvertValueColumns(): Array<String> {
            return arrayOf<String>("id")
        }

        override fun getColumns(): SqlColumnNames {
        ...
        override fun getAutoIncrementKey(): String {
            return ""
        }

        override fun getUks(): Array<Array<String>> {
            return arrayOf(arrayOf("id"))
        }

        override fun getFks(): Array<FkDefine> {
            return arrayOf()
        }
    ...
    class s_city_table(datasource: String = "") :
        ...
        override fun getColumns(): SqlColumnNames {
            return SqlColumnNames(code, shortName, name, level, lng, lat, pinyin, telCode, postCode, pcode)
        }
    ...
    class s_dustbin_table(datasource: String = "") :
        ...
        override fun getColumns(): SqlColumnNames {
            return SqlColumnNames(table, remark, creator_id, creator_name, data, id, createAt)
        }
    ...
    class s_log_table(datasource: String = "") :
        ...
        override fun getColumns(): SqlColumnNames {
            return SqlColumnNames(module, type, tags, msg, request, data, response, creatorId, id, createAt)
        }
