...
//        var select  = select as SqlQueryClip< SqlBaseMetaTable<out java.io.Serializable>, java.io.Serializable>
...
//        }
    ...
    override fun select(select: SqlBaseQueryClip, eventData: EventResult?, result: List<MutableMap<String, Any?>>) {
        ...
        var select = select as SqlQueryClip<SqlBaseMetaTable<java.io.Serializable>, java.io.Serializable>
        var spreads = select.mainEntity.getSpreadColumns();
