...
class BatchReader<T> private constructor(
    ...
    companion object {
        @JvmStatic
        fun <T> init(batchSize: Int = 20, producer: (Int, Int) -> List<T>): nbcp.base.comm.BatchReader<T> {
            return nbcp.base.comm.BatchReader.Companion.init(0, batchSize, producer);
        }

        @JvmStatic
        fun <T> init(producer: (Int, Int) -> List<T>): nbcp.base.comm.BatchReader<T> {
            return nbcp.base.comm.BatchReader.Companion.init(0, 20, producer);
        }
